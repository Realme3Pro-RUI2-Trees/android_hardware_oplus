...
#include <vendor/oplus/hardware/biometrics/face/1.1/IBiometricsFace.h>
#include <vendor/oplus/hardware/biometrics/face/1.1/IBiometricsFaceClientCallbackEx.h>
...
using IOplusBiometricsFace =
        vendor::oplus::hardware::biometrics::face::V1_1::IBiometricsFace;
using vendor::oplus::hardware::biometrics::face::V1_1::
        IBiometricsFaceClientCallbackEx;
...
class BiometricsFace : public V1_0::IBiometricsFace {
  ...
  private:
    ...
    sp<IOplusBiometricsFace> mOplusBiometricsFace;
    sp<IBiometricsFaceClientCallbackEx> mOplusBiometricsFaceCallback;
};
